            ...
            <div style={{
              ...
              <div style={{
                ...
                {!loading && isCoordinadoresView && filtered.length > 0 && (
                  <div style={{
                    display:             'grid',
                    gridTemplateColumns: isMobile ? '1fr' : 'repeat(3, minmax(0, 230px))',
                    gap:                 14,
                    justifyContent:      'center',
                    margin:              '0 auto',
                    width:               '100%',
    ...
    <div style={{
      ...
      <div style={{ display:'flex', alignItems:'center', justifyContent:'center', width:'100%', marginBottom:16 }}>
        <div style={{ display:'flex', alignItems:'center', gap:6,
          ...
          <svg width="11" height="11" viewBox="0 0 24 24" fill="#f59e0b"><path d="M2 20h20v2H2zM3 13l4-8 5 4 5-4 4 8H3z"/></svg>
          <span style={{ fontSize:9, fontWeight:800, color:'#fff', letterSpacing:'2px', textTransform:'uppercase' }}>Administrador</span>
        </div>
      </div>
      ...
      <div style={{ textAlign:'center', marginBottom:10 }}>
        <div style={{ fontSize:14, fontWeight:800, color:'#fff', lineHeight:1.25, textShadow:'0 1px 4px rgba(0,0,0,.2)' }}>
          {a.nombre} {a.apellido}
        </div>
        <div style={{ fontSize:10, color:'rgba(255,255,255,.7)', fontWeight:500, marginTop:3 }}>
          Administrador Kids
        </div>
      </div>
      ...
      {a.telefono && (
        <div style={{ display:'flex', gap:6, marginBottom:8, width:'100%' }}>
          <a href={`https://wa.me/57${phone}`} target="_blank" rel="noopener noreferrer"
            {...h('wa')}
            style={{ flex:1, display:'flex', alignItems:'center', justifyContent:'center', gap:5, padding:'8px 0', borderRadius:50, background:'#25D366', color:'#fff', fontSize:10, fontWeight:700, textDecoration:'none',
              boxShadow:  hov === 'wa' ? '0 0 24px rgba(37,211,102,.52), 0 6px 20px rgba(37,211,102,.38)' : '0 4px 12px rgba(37,211,102,.4)',
          ...
          <a href={`tel:${a.telefono}`}
            {...h('tel')}
            style={{ flex:1, display:'flex', alignItems:'center', justifyContent:'center', gap:5, padding:'8px 0', borderRadius:50,
              background:'rgba(255,255,255,.22)', color:'#fff', border:'1px solid rgba(255,255,255,.45)',
              fontSize:10, fontWeight:700, textDecoration:'none',
              boxShadow:  hov === 'tel' ? '0 0 22px rgba(200,210,255,.55), 0 6px 16px rgba(180,190,255,.35)' : 'none',
      ...
      <div style={{ display:'flex', gap:8, width:'100%' }}>
        <button onClick={onEdit} {...h('edit')} style={{
          flex:1, padding:'8px 0', borderRadius:50, cursor:'pointer',
          background:'rgba(255,255,255,.25)', border:'1px solid rgba(255,255,255,.5)',
          color:'#fff', fontSize:11, fontWeight:700,
          boxShadow:  hov === 'edit'
            ? '0 0 22px rgba(255,255,255,.52), 0 4px 16px rgba(200,210,255,.3), inset 0 1px 0 rgba(255,255,255,.4)'
        ...
        <button onClick={() => !isDeleting && onDelete()} disabled={isDeleting} {...h('del')} style={{
          ...
          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#fca5a5" strokeWidth="2.2" strokeLinecap="round">
            <polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14H6L5 6"/>
            <path d="M10 11v6M14 11v6"/><path d="M9 6V4h6v2"/>
          </svg>
        </button>
    ...
    >
      ...
      <div style={{ display:'flex', alignItems:'center', justifyContent:'center', width:'100%', marginBottom:12 }}>
        <div style={{ display:'flex', alignItems:'center', gap:6,
          ...
          <span style={{ fontSize:9, fontWeight:800, color:'#fff', letterSpacing:'2px', textTransform:'uppercase' }}>Coordinadora</span>
        </div>
      </div>
      ...
      {c.grupo_asignado && (
        <div style={{
          ...
          fontSize:10, fontWeight:800, marginBottom:10, letterSpacing:'0.5px',
        }}>
          {c.grupo_asignado}
        </div>
      )}
      ...
      {c.telefono && (
        <div style={{ display:'flex', gap:6, marginBottom:8, width:'100%' }}>
          <a href={`https://wa.me/57${phone}`} target="_blank" rel="noopener noreferrer"
            ...
            {...h('wa')}
            style={{ flex:1, display:'flex', alignItems:'center', justifyContent:'center', gap:5, padding:'8px 0', borderRadius:50,
              background:'#25D366', color:'#fff', fontSize:10, fontWeight:700, textDecoration:'none',
