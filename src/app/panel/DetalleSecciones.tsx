  ...
  return (
    <div className="grid premium-grid">
      ...
      {view === "asistencias" && (
        <>
          {/* PANEL IZQUIERDO */}
          <section className="card premium-glass animate-slideIn relative">
            <div className="card-head">
              <h2 className="card-title">Gráfico de Asistencias</h2>
            </div>

            {/* Etiquetas arriba */}
            <div className="flex justify-between w-full px-6 mt-2 mb-4">
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center pointer-events-none">
                <p className="text-4xl leading-tight font-extrabold text-gray-900 tabular-nums">
          ...
          {/* PANEL DERECHO */}
          <section className="card premium-glass animate-slideIn h-auto">
            <div className="card-head pb-0">
              <h2 className="card-title">Detalle por etapa</h2>
            </div>

            <div className="card-body px-0 py-0">
              <div className="premium-table-row bg-gray-50/70 font-semibold text-xs text-gray-500">
                <span>Etapa</span>
              ...
              {asistEtapas.map((row: any, i: number) => (
                <div
                  key={i}
                  className="premium-table-row hover:bg-gray-50/60 transition-colors"
                >
                  <span className="font-medium text-gray-700">{row.etapa}</span>
        ...
        <>
          ...
          <section className="card premium-glass animate-slideIn h-auto">
            ...
            <div className="card-body px-0 py-0">
              ...
              <div className="premium-table-row bg-gray-50/70 font-semibold">
                <span>Total</span>
