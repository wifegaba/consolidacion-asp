          ...
          <div style={{
              ...
              <div style={{
                ...
                <div style={{ display:'flex', gap:6, alignItems:'center', flexWrap:'wrap' }}>
                  ...
                  {(['todos', 'coordinadores', 'maestros', 'auxiliares', 'timoteos'] as FilterTab[]).map(t => {
              ...
              {/* Strips */}
              <div style={{
                padding: isMobile ? '10px 12px 90px' : '10px 16px 76px',
  ...
  return (
      ...
      <div style={{
        ...
        >
          ...
          <div style={{ display:'flex', alignItems:'center', gap:3,
            ...
            <svg width="7" height="7" viewBox="0 0 24 24" fill="#2466f2" style={{ flexShrink:0 }}><path d="M2 20h20v2H2zM3 13l4-8 5 4 5-4 4 8H3z"/></svg>
            <span style={{ fontSize:7, fontWeight:800, color:'#2466f2', letterSpacing:'0.5px', textTransform:'uppercase', overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap' }}>
              {(a.roles && a.roles.length > 0) ? a.roles.map((r: any) => r.replace(/_/g, ' ')).join(' • ') : 'SERVIDOR'}
            </span>
          </div>
          ...
          <div style={{ textAlign:'center', width:'100%', paddingInline:4, marginBottom:0 }}>
            ...
            <div style={{ fontSize:8.5, color:'#53617d', fontWeight:600, marginTop:1, overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap' }}>
              {(a.roles && a.roles.length > 0) ? a.roles.map((r: any) => r.replace(/_/g, ' ')).join(' • ') : 'Servidor Kids'}
            </div>
          </div>
    ...
    {expanded && createPortal(
      <ServerAladdinModal
        ...
        onEdit={() => { closeExpanded(); window.setTimeout(onEdit, 640) }}
