...
export default function SeguimientosSection() {
  ...
  return (
    ...
    <div style={{
      ...
      background:'linear-gradient(145deg,rgba(248,246,255,.38) 0%,rgba(237,233,254,.26) 60%,rgba(224,242,254,.32) 100%)',
      overflow:'hidden',
    }}>
      ...
      <div style={{
        ...
        padding: isMobile ? '16px 14px 40px' : isCompact ? '18px 24px 42px' : '22px 30px 48px',
